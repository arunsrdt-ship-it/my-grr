      ...
      <div className="enrolled-items">
        <div className="heading flex items-center justify-between">
          <div className="flex items-center text-xl  gap-1">
            <h3 className="font-bold text-2xl ">More Courses Like This</h3>
          </div>
          <div>
            <span className="main-color-text cursor-pointer">See All</span>
          </div>
        </div>
        <div className="enrolled-cards mt-10 flex    flex-wrap gap-5">
          <div className="card cursor-pointer  p-2  border-1 border-gray-200 rounded-xl w-70 ">
            <div className="image">
              <img src={ENROLLED} />
            </div>
